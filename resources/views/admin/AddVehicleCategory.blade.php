  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fa fa-plus-circle" aria-hidden="true"></i>   Add Vehicle Category</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="type" name="type" placeholder="Vehicle Category">
                  </div>
