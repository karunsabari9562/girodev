          ...
          <div class="card-body">
           ...
           <div class="card-body">
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="b1" value="Invalid RC">
                  <label for="b1" class="custom-control-label">Invalid RC</label>
                </div>
...
processData: false,
      ...
      $('#bt5').show();
               swal({
                       title: "Vehicle RC sent for admin approval successfully",
