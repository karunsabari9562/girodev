  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border:none;">
      <div class="modal-header" style="background:#fab60b;color: white;border:none; ">
        <h5 class="modal-title" id="exampleModalLabel"  style="font-size: 25px;font-weight: bold;"><i>   Reject Vehicle Insurance</i></h5><i class="fa fa-times-circle" aria-hidden="true" style="font-weight: bold;font-size: 25px;cursor: pointer;" onclick="document.getElementById('addreg').style.display='none'"></i>
  ...
  <div class="content-wrapper kanban">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1>Vehicle Insurance Approval</h1>
          </div>
...
<div class="card card-row">
          ...
          <div class="card-body">
            <div class="card card-primary card-outline">
              ...
              <center>
                <div class="card-header">
                   <a href="{{asset($docs->doc_file)}}" target="_blank" class="nav-link"><img src="{{ asset('default/file.png')}}" class="img-circle" alt="User Image" style="width: 50%;"></a>
              </div>
             </center>
 ...
 function Approve()
    {
      ...
      swal({
  title: "Do you want to approve this Vehicle Insurance ?",
  text: "Ensure that the Vehicle Insurance validated thoroughly.",
  icon: "warning",
  buttons: ["No", "Yes"],
})
...
.then((willDelete) => {
  ...
  data.append('_token', "{{ csrf_token() }}");
      ...
      $.ajax({
        ...
        type:"POST",
        url:"/girokab-admin/insurance-reapproval",
         data: data,
        dataType:"json",
        contentType: false,
//cache: false,
processData: false,
      ...
      $('#bt5').show();
               swal({
                       title: "Vehicle Insurance approved successfully",
    ...
    success:function(data)
    {
      if(data['success'])
      {
        ...
        $('#ab1').show();
          ...
          swal({
                              title: "Vehicle Insurance rejected successfully.",
