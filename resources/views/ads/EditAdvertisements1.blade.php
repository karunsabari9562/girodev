        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="/blocked-advertisement"><i class="fa fa-arrow-left" aria-hidden="true"></i>  back</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form>
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label for="customCheckbox2" class="custom-control-label">Passengers</label>
                </div>
                <div class="custom-control custom-checkbox">
          ...
          if(data['success'])
          {
              ...
              $('#submitButton').show();
               swal({
                     ...
                     .then((willDelete) => {
                      if (willDelete) {
                       window.location.href='/blocked-advertisemen';
                               } 
