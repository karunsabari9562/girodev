...
<body class="hold-transition login-page" style="background-color:white;">
   ...
   <!--<img class="wave" src="img/login.jpeg">-->
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg" style="font-size: 20px;font-weight: bold;">Division</p>
...
<script>
        Echo.channel('mychannel')
            .listen('NewDriverRegistration', (e) => {
                // console.log(e.trade);
                alert('ssss');
            })
    </script>
