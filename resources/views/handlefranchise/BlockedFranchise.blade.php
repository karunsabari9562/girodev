          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                 <h2 class="card-title" style="font-size: 25px;font-weight: bold;">Blocked Divisions</h2>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($franchise as $f )
                     @php
                    $dt = date("d-m-Y", strtotime($f->blocked_date));
                  ...
                  <tr>
                   ...
                   <!--  <td>{{ $f->GetDist->district }}</td>
                    <td>{{ $f->franchise_location }}</td> -->
