              ...
              <div class="row invoice-info">
                ...
                @switch($bookings->status)
                      ...
                      @break
                        ...
                        <div class="col-sm-4 invoice-col" style="border: 1px solid #e1e1e1;">
                        <strong><u>Offline Payment Approval</u></strong>
                        <address>
                        
                        <br> <strong>Div.approval </strong> : 
                        @if($bookings->offline_pay_franchise==1)
                        Approved at {{$bookings->offline_pay_franchisedt->format('d-m-Y')}}
                        @else
                        <span class="badge badge-warning">pending</span>
                        @endif<br>
                         <strong>Admin approval  </strong>: 
                        @if($bookings->offline_pay_admin==1)
                        Approved at{{$bookings->offline_pay_admindt->format('d-m-Y')}}
                        @else
