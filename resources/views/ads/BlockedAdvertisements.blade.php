              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $v->title }}</td>
                    <td> <a href="{{asset($v->photo)}}" target="_blank" data-toggle="lightbox" data-title="sample 3 - red" data-gallery="gallery">
                      <img src="{{asset($v->photo)}}" class="img-fluid mb-2" alt="red sample" style="width: 110px;"/>
                    </a>
                ...
                <td>
                  <a style="cursor: pointer;background-color: blue;border:none;" href="/edit-advertisements/{{encrypt($v->id)}}" class="btn btn-danger btn-sm"><b> <i class="fa fa-edit" aria-hidden="true"></i></b></a>
                      @if($v->status==1)
