...
@section('contents')
            ...
            <div class="col-12 col-md-12 col-lg-6 order-1 order-md-2">
             ...
             <div class="card-block">
                 <i class="fa fa-search mr-2" aria-hidden="true"></i>
                  <h3 class="text-primary mb-0">Drivers Payments </h3>
             </div>
              <form class="form-horizontal" action="/girokab-admin/driver-payments" method="post" target="_blank">
                @csrf
                <div class="card-body">
 ...
 -->
            ...
            <div class="col-12 col-md-12 col-lg-6 order-1 order-md-2">
             ...
             <div class="card-block">
                 <i class="fa fa-search mr-2" aria-hidden="true"></i>
                  <h3 class="text-primary mb-0">Division Payments </h3>
             </div>
              <form class="form-horizontal" action="/girokab-admin/division-payments" method="post" target="_blank">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Div *</label>
                    <div class="col-sm-10">
