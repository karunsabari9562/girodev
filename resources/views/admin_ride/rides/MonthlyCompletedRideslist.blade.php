              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <tr>
                   ...
                   <td>Id: <a href="/girokab-admin/active-driver-profile/{{encrypt($b->driver_id)}}" target="_blank"> {{$b->GetDriver->driver_id}}</a><br>Div: <a href="/franchise-details/{{encrypt($b->franchise)}}" target="_blank"> ({{$b->GetFranchise->franchise_id}})</a></td>
