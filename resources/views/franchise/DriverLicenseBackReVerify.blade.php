          ...
          <div class="card-body">
           ...
           <div class="card-body">
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="b1" value="Invalid Driving License">
                  <label for="b1" class="custom-control-label">Invalid Driving License</label>
                </div>
...
processData: false,
      ...
      $('#bt5').show();
               swal({
                       title: "Driving License Backside sent for admin approval successfully",
