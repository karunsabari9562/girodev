       ...
       <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <p class="lead">Summary - {{date("Y-M", strtotime(date('Y-m-d')))}}</p>
                ...
                <p class="lead">Summary</p>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                        ...
                        <td style="font-size: 17px;font-weight: bold;">Rs.{{$drsum}}</td>
                      </tr>
                      ...
                      <tr style="font-weight: bold;">
                        ...
                        <td style="font-size: 17px;">Rs.{{$adsum}}</td>
                      </tr>

                      <tr style="font-weight: bold;">
                        <th>Admin Ride Commission</th>
                        <td style="font-size: 17px;">Rs.{{$adrsum}}</td>
                      </tr>
                      <tr style="font-weight: bold;">
                        <th>View Rides</th>
                        <td style="font-size: 17px;"> <a  href="/girokab-admin/completed-all-mrides" class="btn yellowbtn btn-sm" target="_blank"><b> View </b></a></td>
                      </tr>
                    </table>
