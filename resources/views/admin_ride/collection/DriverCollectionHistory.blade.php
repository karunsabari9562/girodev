      ...
      <h3 class="card-title">Collection Summary</h3>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <p class="lead">Summary - {{date("d-m-Y", strtotime($dat))}}</p>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <tbody>
                    ...
                    @php
                    $dt=date('Y-m-d');
                    $cnt=DB::table('ride_booking_histories')->where('driver_id',$b->driver_id)->where('status',6)->where('booked_date',$dat)->count();
                    @endphp
                  ...
                  <tr>
                   ...
                   <td>{{$cnt}}</td>
                  <td>
                    <a style="cursor: pointer;background-color: #fab60b;border:none;" href="/girokab-admin/driver-rides-list/{{encrypt($b->driver_id)}}/{{$dat}}" class="btn btn-danger btn-sm" target="_blank"><b> View </b></a>
                </td>
