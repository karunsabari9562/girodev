  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border:none;">
      <div class="modal-header" style="background:#fab60b;color: white;border:none; ">
        <h5 class="modal-title" id="exampleModalLabel"  style="font-size: 25px;font-weight: bold;"><i>  Reject Vehicle Permit</i></h5><i class="fa fa-times-circle" aria-hidden="true" style="font-weight: bold;font-size: 25px;cursor: pointer;" onclick="document.getElementById('addreg').style.display='none'"></i>
 ...
 function Approve()
    {
      ...
      swal({
  title: "Do you want to approve this Vehicle Permit ?",
  text: "Ensure that the Vehicle Permit validated thoroughly.",
  icon: "warning",
  buttons: ["No", "Yes"],
})
...
.then((willDelete) => {
  ...
  data.append('_token', "{{ csrf_token() }}");
      ...
      $.ajax({
        ...
        type:"POST",
        url:"/girokab-admin/permit-reapproval",
         data: data,
        dataType:"json",
        contentType: false,
//cache: false,
