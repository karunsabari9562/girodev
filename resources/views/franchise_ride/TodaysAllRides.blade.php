              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <tr>
                    ...
                    <td title="From : {{ $b->from_location}} , To : {{ $b->to_location }}" style="cursor: pointer;">
                      From : {{ Str::limit($b->from_location, 20, '...') }}<br>
                   ...
                   @switch($b->status)
                      ...
                      <td><span class="badge badge-info">completed</span><br>
                       ...
                       <td>Status : @if($b->payment_status==1)Paid @else Pending @endif<br>
                           Type : @if($b->payment_type==1)Online @else Offline @endif<br>
                           Amount : Rs.{{$b->paid_amount}}<br>
                          </td>
                       ...
                       <td>
                    <a style="cursor: pointer;background-color: #fab60b;border:none;" href="/rides-details/{{encrypt($b->id)}}" class="btn btn-danger btn-sm" target="_blank"><b> View </b></a>
                </td>
