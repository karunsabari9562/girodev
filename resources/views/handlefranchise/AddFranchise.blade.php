            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select id="ftype" name="ftype" class="form-control">
                    ...
                    <option  value="1">Own Division</option>
                    <option  value="2">Other Division</option>
                    
                  </select>
                </div>
                 <div class="form-group">
                  <label>Division Name *</label>
                  <input type="text" name="cname" id="cname" class="form-control" value="">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label>Mobile *</label>
                  <input type="text" name="cmobile" id="cmobile" class="form-control" value="">
                </div>

                <div class="form-group">
                  <label>Mail Id *</label>
                  <input type="text" name="cmail" id="cmail" class="form-control" value="">
                </div>

                 <div class="form-group">
                  <label>Location *</label>
                  <input type="text" name="clocation" id="clocation" class="form-control" value="">
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="valdate" id="valdate" class="form-control" value="{{ $validity}}">
                </div>
                
                <div class="form-group">
                  <label>Landline</label>
                  <input type="text" name="clandline" id="clandline" class="form-control" value="">
                </div>
                
                <div class="form-group">
                  <label>Division Id</label>
                  <input type="text" name="frid" id="frid" class="form-control" value="DIV{{$lst_fr}}" readonly="">
                </div>
 ...
 function AddFranchise()
{
  ...
  var valdate=$('input#valdate').val();
    if(valdate=='')
    {
        $('#valdate').focus();
        $('#valdate').css({'border':'1px solid red'});
        swal({
    ...
    $('#valdate').css({'border':'1px solid #CCC'});


    var clandline=$('input#clandline').val();
    var frid=$('input#frid').val();
...
data.append('fid', '{{$lst_fr}}');
data.append('frid', frid);
