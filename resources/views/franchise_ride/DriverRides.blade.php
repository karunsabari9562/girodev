                     ...
                     <td>Rs.{{$b->total_fare}}</td>
                      ...
                      @else
                        @if($b->offline_pay_admin==0)
                         <td><a href="/rides-details/{{encrypt($b->id)}}" target="_blank" style="font-size:13px;color:red">pending<i class="fa fa-exclamation-triangle"></i></a></td>
                        @else
                          <td>approved</td>
                        @endif
                      @endif
                      ...
                      <td>
                    <a style="cursor: pointer;background-color: #fab60b;border:none;" href="/rides-details/{{encrypt($b->id)}}" class="btn btn-danger btn-sm" target="_blank"><b> View
                    </td>
                    </tr>
                  @endforeach
