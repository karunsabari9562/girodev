  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fa fa-plus-circle" aria-hidden="true"></i>   Edit Vehicle Type</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="/vehicle-types/{{encrypt($vtypes->category)}}"><i class="fa fa-arrow-left" aria-hidden="true"></i>  back</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="type" name="type" value="{{$vtypes->type}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="sr_charge" name="sr_charge" value="{{$vtypes->service_charge}}">
                  </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  ...
                  <div class="input-group">
                     <input type="number" class="form-control" id="mincharge" value="{{$vtypes->minimum_fare}}">
               ...
               <div class="col-md-4">
                 <label class="col-sm-12 control-label">Min.Distance(Km) *</label>
                  <div class="input-group">
                     <input type="number" class="form-control" id="mindist" value="{{$vtypes->minimum_distance}}">
               ...
               <div class="col-md-4">
                  ...
                  <div class="input-group">
                     <input type="number" name="charge" id="charge" class="form-control" value="{{$vtypes->fare}}">
         ...
         <div class="col-sm-10">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="input-group">
                     <input type="number" class="form-control" id="ride_tax" value="{{$vtypes->ride_tax}}">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                     <input type="number" class="form-control" id="dr_profit" value="{{$vtypes->driver_profit}}">
              ...
              <!--  <div class="col-md-4" >
                 <label class="col-sm-12 control-label">Division Profit/Ride(%) *</label>
                  <div class="input-group">
                     <input type="number" class="form-control" id="div_profit" value="{{$vtypes->div_profit}}">
         ...
         <div class="col-sm-10">
            <div class="row">
               ...
               <div class="col-md-3">
                  ...
                  <div class="input-group" >
                     <select class="form-control" id="spstat">
                       <option value="1" @if($vtypes->special_ride==1) selected @endif>Enabled</option>
                       <option value="2" @if($vtypes->special_ride==2) selected @endif>Disabled</option>
                     </select>
               ...
               <div class="col-md-3">
                  ...
                  <div class="input-group">
                     <input type="time" class="form-control" id="tfrom" value="{{$vtypes->timefrom}}">
               ...
               <div class="col-md-3">
                 <label class="col-sm-8 control-label">Time To</label>
                  <div class="input-group">
                     <input type="time" class="form-control" id="tto" value="{{$vtypes->timeto}}">
                ...
                <div class="col-md-3">
                  ...
                  <div class="input-group" >
                     <select class="form-control" id="mlnum">
                      <option value="" @if($vtypes->sp_charge=='') selected @endif>Choose</option>
                       <option value="1.5" @if($vtypes->sp_charge=='1.5') selected @endif>1/2x (E.g:Rs.20 -> Rs.30)</option>
                       <option value="2" @if($vtypes->sp_charge=='2') selected @endif>2x (E.g:Rs.20 -> Rs.40)</option>
                     </select>
          ...
          if(data['success'])
          {
              ...
              $('#ab1').show();
               ...
               swal({
                     ...
                     .then((willDelete) => {
                      if (willDelete) {
                       window.location.href='/vehicle-types/' + '{{encrypt($vtypes->category)}}';
                               } 
