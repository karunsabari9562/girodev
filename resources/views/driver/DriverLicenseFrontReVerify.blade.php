  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border:none;">
      <div class="modal-header" style="background:#fab60b;color: white;border:none; ">
        <h5 class="modal-title" id="exampleModalLabel"  style="font-size: 25px;font-weight: bold;"><i>   Reject Driving License</i></h5><i class="fa fa-times-circle" aria-hidden="true" style="font-weight: bold;font-size: 25px;cursor: pointer;" onclick="document.getElementById('addreg').style.display='none'"></i>
 ...
 function Approve()
    {
      ...
      swal({
  title: "Do you want to approve this Driving License ?",
  text: "Ensure that the Driving License validated thoroughly.",
  icon: "warning",
  buttons: ["No", "Yes"],
})
...
.then((willDelete) => {
  ...
  data.append('_token', "{{ csrf_token() }}");
      ...
      $.ajax({
        ...
        type:"POST",
        url:"/girokab-admin/license-reapproval",
         data: data,
        dataType:"json",
        contentType: false,
//cache: false,
processData: false,
      ...
      $('#bt5').show();
               swal({
                       title: "Driving License approved successfully",
    ...
    success:function(data)
    {
      if(data['success'])
      {
        ...
        $('#ab1').show();
          ...
          swal({
                              title: "Driving License rejected successfully.",
