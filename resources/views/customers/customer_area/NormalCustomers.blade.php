            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-striped">
                 ...
                 <td>
                  <a style="cursor: pointer;background-color: #fab60b;border:none;" href="/girokab-admin/customer-profile/{{encrypt($c->id)}}" target="_blank" class="btn btn-danger btn-sm"><b> View      </b></a>
                </td>
