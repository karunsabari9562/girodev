          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h1 class="card-title p-3" style="font-size: 20px;font-weight: bold;">Cancelled Rides - {{date("Y-M", strtotime(date('Y-m-d')))}}</h1>
            ...
            <td title="From : {{ $b->from_location}}<br>To : {{ $b->to_location }}" style="cursor: pointer;">From : {{ Str::limit($b->from_location, 20, '...') }}<br>To : {{ Str::limit($b->to_location, 20, '...') }}</td>
