  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fa fa-plus-circle" aria-hidden="true"></i>   Add Advertisement</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form>
                ...
                color: black;padding: 1em;">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="vfrom" name="vfrom" min="{{date('Y-m-d')}}">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Valid to *</label>
                    <input type="date" class="form-control" id="vto" name="vto" min="{{date('Y-m-d')}}">
                  </div>
                ...
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="customCheckbox1" value="1" checked="">
                  <label for="customCheckbox1" class="custom-control-label">Drivers</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="customCheckbox2" value="2" checked="">
                  <label for="customCheckbox2" class="custom-control-label">Customers</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="customCheckbox3" value="3" checked="">
