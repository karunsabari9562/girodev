  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border:none;">
      <div class="modal-header" style="background:#fab60b;color: white;border:none; ">
        <h5 class="modal-title" id="exampleModalLabel"  style="font-size: 25px;font-weight: bold;"><i>  Reject Pollution Certificate</i></h5><i class="fa fa-times-circle" aria-hidden="true" style="font-weight: bold;font-size: 25px;cursor: pointer;" onclick="document.getElementById('addreg').style.display='none'"></i>
 ...
 function Approve()
    {
     ...
     swal({
  title: "Do you want to approve this Vehicle Pollution Certificate ?",
...
processData: false,
      ...
      $('#bt5').show();
               swal({
                       title: "Vehicle Pollution Certificate approved successfully",
